...
/**
 **	Maximum path length. We're defining it here instead of relying
 **	on an external symbol. If you're so smarty pants that you have
 **	paths that can be larger than this, you can deal with increasing
 **	the value here.
 **/

#define IMHTTPD_MAX_PATH		4096
